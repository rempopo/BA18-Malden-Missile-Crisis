...
MissionCondition3 = [ "FAIL_1__O_MINOR_VICTORY", 	{ ALIVE_TGTS == 1 && { BLUFOR_ESCAPED || BLUFOR_DEAD} }, "BLUFOR retreated, but there are still Launchers alive" ];
MissionCondition4 = [ "FAIL_2__O_MAJOR_VICTORY", 	{ ALIVE_TGTS > 1 && { BLUFOR_ESCAPED || BLUFOR_DEAD} }, "BLUFOR retreated, but there are still Launchers alive" ];
